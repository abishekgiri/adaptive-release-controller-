...
\begin{table*}[ht]\centering\begin{tabular}{lll}
\toprule\noalign{}
...
\begin{table*}[ht]\centering\begin{tabular}{llll}
\toprule\noalign{}
...
bars = $\pm$1 std). Thompson's higher cost and wider spread relative to
...
\begin{table*}[ht]\centering\begin{tabular}{lllllll}
\toprule\noalign{}
Policy
...
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
\texttt{linucb}
\end{minipage} & Optimal arm (expected cost)
 \\
\midrule\noalign{}
\bottomrule\noalign{}
...
\begin{table*}[ht]\centering\begin{tabular}{llllll}
\toprule\noalign{}
Variant
 & \begin{minipage}[b]{\linewidth}\raggedleft
Cumul. Cost
...
Component
 & \begin{minipage}[b]{\linewidth}\raggedleft
$\Delta$ vs.~\texttt{no\_drift}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
$\Delta$\%
\end{minipage} & Interpretation
 \\
\midrule\noalign{}
\bottomrule\noalign{}
...
cost per policy on real GitHub Actions data (n=30 seeds, error bars = $\pm$1
...
\begin{table*}[ht]\centering\begin{tabular}{llllllll}
\toprule\noalign{}
Policy
 & \begin{minipage}[b]{\linewidth}\raggedleft
Steps
...
cost matrix is asymmetric (20$\times$ ratio between deploy+failure and
...
\textbf{F3: Page-Hinkley at $\lambda$\_PH = 50 fires 44 false alarms on 1,150
...
therefore high cost-asymmetry regimes (ratio $\geq$ 40:1), where the
...
of mean cumulative cost by drift mode $\times$ policy.
