...
| 2 | §5.1 above Table 1 | `fig_cumulative_cost_curves` | `experiments/results/online_smoke/{seed}/step_costs_{pid}.npy` | 0–29 |
| 3 | §5.3 above Table 2 | `fig_ablation_bars` | `experiments/results/ablation_smoke/0/ablation_summary.json` | 0 only |
| 4 | §5.4 above Table 3 | `fig_cumulative_cost_real` | `experiments/results/real_github_actions/{0..29}/online_summary.json` | 0–29 |
| 5 | §5.4 above Table 3 | `fig_action_distribution` | both online\_smoke and real\_github\_actions summary JSONs | 0–29 |
| 6 | §5.4 above Table 3 | `fig_thompson_seed_distribution` | per-seed `thompson.cumulative_cost` from summary JSONs | 0–29 |
| 7 | §5.4 above Table 3 | `fig_cost_cdf_per_step` | `experiments/results/real_github_actions/{seed}/step_costs_{pid}.npy` | 0–29 |
| 8 | §6.4 F11 | `fig_cost_sweep` | `experiments/results/cost_sweep/cost_sweep_summary.json` | 0–29 |
| 9 | §6.4 F12 | `fig_drift_mode_bars` | `experiments/results/drift_eval/drift_eval_summary.json` | 0–29 |
| 10 | §6.4 F12 | `fig_drift_recovery_curves` | `experiments/results/drift_eval/step_regrets_{mode}_{pid}.npy` | 0–29 (mean) |
